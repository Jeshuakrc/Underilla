...
- Little underground lava and water pockets will translate to odd floating blobs in the final world if they overlap with large caves (Relative config only). Avoid such generation patterns.
